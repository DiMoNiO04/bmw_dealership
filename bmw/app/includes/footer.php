      ...
      <div class="footer__container">
        <div class="footer__content">
          ...
          <ul class="footer__items">
            ...
            <li><a class="footer__items-link" href="<?= BASE_URL ?>/about">О компании</a></li>
            <li><a class="footer__items-link" href="<?= BASE_URL ?>/service">Услуги и сервис</a></li>
            <li><a class="footer__items-link" href="<?= BASE_URL ?>/contacts">Контакты</a></li>
          </ul>
