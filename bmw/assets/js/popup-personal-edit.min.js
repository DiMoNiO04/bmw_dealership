...
CLOSE_BUTTON_PASSWORD.addEventListener('click', togglePopupDarkPassword),
  ...
  POPUP_PASSWORD.addEventListener('click', (e) => {
    isContainsPopup() && togglePopupDarkPassword();
  });
...
CLOSE_BUTTON_PERSONAL.addEventListener('click', togglePopupDarkPersonal),
  ...
  POPUP_PERSONAL.addEventListener('click', (e) => {
    isContainsPopup() && togglePopupDarkPersonal();
  });
