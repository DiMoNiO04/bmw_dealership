				...
				<div class="company__container">
					...
					<div class="company__links">
						<div class="company__link">
							...
							<a class="button button__company" href="./service.php" title="Услуги">Подробнее</a>
						</div>
						<div class="company__link">
							<h2 class="link__title">Ознакомиться с контактами</h2>
							<a class="button button__company" href="./contacts.php" title="Контакты">Подробнее</a>
						</div>
						<div class="company__link">
							<h2 class="link__title">Ознакомиться с автомобилимя</h2>
							<a class="button button__company" href="./autos.php" title="Автомобили">Подробнее</a></button>
						</div>
					</div>
		...
		<div class="container">
			<div class="footer__container">
				<div class="footer__content">
					<a href="./index.html" class="footer__logo-bmw">
